      ...
      <div className="flex-1">
        ...
        <div className="p-8 max-w-[1400px] mx-auto ">
          ...
          <section className="flex gap-4 mt-10">
            <a className="flex h-[120px] w-[50%] rounded-lg hover:cursor-pointer">
              <div className="bg-green-500 flex w-[25%]  rounded-l-lg justify-center items-center hover:bg-green-600 transition-all">
              ...
              <div className="flex justify-center p-4  rounded-r-lg bg-gray-700 items-center">
                <div className="flex pr-2 flex-col">
                  <h2 className="text-2xl leading-relaxed mb-2 font-bold">

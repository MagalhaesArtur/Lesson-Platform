...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, title: string, slug: string, lessonType: LessonType, id: string }> };
